...
public Init(...)
{
	dialogBackground = ObjectCreate("", RECTANGLE, 0, 0, 6000, 640, 480, 0x00000066);
	dialogBox = ObjectCreate("sprite-border.png:5", SPRITE, 160, 160, 6001, 320, 160, 0xFFFFFFFF);
...
HandleDialog()
{
	if (dialogLine != NO_DIALOG)
	{
		...
		GraphicsDraw(dialogString, TEXT, 160, 160, 6002, 0, 0, 0x421234FF);
		CheckForClose();
	}
	else
	{
