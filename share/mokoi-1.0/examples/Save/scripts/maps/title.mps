...
main()
{
	...
	GraphicsDraw(stringinfo[0], TEXT, 36,48,4.000,0,0, 0xFFFFFFFF); 
	...
	GraphicsDraw(stringinfo[1], TEXT, 36,128,4.000,0,0, 0xFFFFFFFF); 	
	
	StringFormat(stringinfo[2], _, "Game Saves\nPuttytris High Score: %d", puttytris[0] ); 
	GraphicsDraw(stringinfo[2], TEXT, 36, 208,4.000,0,0, 0xFFFFFFFF); 
