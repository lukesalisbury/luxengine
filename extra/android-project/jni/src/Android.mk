...
LOCAL_SRC_FILES += $(ROOT_SOURCE)/save_system.cpp $(ROOT_SOURCE)/widget.cpp $(ROOT_SOURCE)/world.cpp $(ROOT_SOURCE)/object_effect.cpp $(ROOT_SOURCE)/sprite_sheet.cpp $(ROOT_SOURCE)/graphics_system.cpp $(ROOT_SOURCE)/lux_virtual_sprite.cpp
...
LOCAL_SRC_FILES += $(ROOT_SOURCE)/world_section.cpp  $(ROOT_SOURCE)/map_screen.cpp $(ROOT_SOURCE)/masks.cpp $(ROOT_SOURCE)/test_code.cpp $(ROOT_SOURCE)/lux_polygon.cpp $(ROOT_SOURCE)/map_xml_reader.cpp $(ROOT_SOURCE)/game_config.cpp
LOCAL_SRC_FILES += $(ROOT_SOURCE)/downloader-none.cpp 

LOCAL_SRC_FILES += $(ROOT_SOURCE)/$(PLATFORM_DIRECTORY)/audio.cpp $(ROOT_SOURCE)/$(PLATFORM_DIRECTORY)/core.cpp $(ROOT_SOURCE)/$(PLATFORM_DIRECTORY)/graphics_native.cpp $(ROOT_SOURCE)/$(PLATFORM_DIRECTORY)/worker.cpp
LOCAL_SRC_FILES += $(ROOT_SOURCE)/$(PLATFORM_DIRECTORY)/platform_controls.cpp $(ROOT_SOURCE)/$(PLATFORM_DIRECTORY)/platform_functions.cpp $(ROOT_SOURCE)/$(PLATFORM_DIRECTORY)/platform_media.cpp



LOCAL_SRC_FILES += $(ROOT_SOURCE)/tinyxml/tinyxml2.cpp $(ROOT_SOURCE)/tinyxml/tinyxml2ext.cpp
LOCAL_SRC_FILES += $(ELIX_SOURCE)/elix_directory.cpp $(ELIX_SOURCE)/elix_endian.cpp  $(ELIX_SOURCE)/elix_file.cpp $(ELIX_SOURCE)/elix_string.cpp $(ELIX_SOURCE)/elix_path.cpp $(ELIX_SOURCE)/elix_png.cpp $(ELIX_SOURCE)/elix_program.cpp
...
LOCAL_SRC_FILES += $(ROOT_SOURCE)/scripting/amx4/amx.c $(ROOT_SOURCE)/scripting/amx4/amxcons.c $(ROOT_SOURCE)/scripting/amx4/amxcore.c

LOCAL_SRC_FILES += $(ROOT_SOURCE)/$(PLATFORM_DIRECTORY)/platform_config.cpp $(ROOT_SOURCE)/$(PLATFORM_DIRECTORY)/platform_main.cpp $(ROOT_SOURCE)/lux_screen.cpp $(ROOT_SOURCE)/project_media.cpp 
