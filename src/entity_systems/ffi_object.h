...
uint8_t Lux_FFI_Object_Postion( uint32_t object, int32_t x, int32_t y, int32_t z, uint16_t w, uint16_t h );
int32_t Lux_FFI_Object_Info( uint32_t object_id, uint16_t * w, uint16_t * h );
