...
namespace gles {
	void render(GLenum mode, LuxVertex * vertexs, uint16_t count, Texture * texture, LuxVertex dest, float angle, LuxColour * colour , LuxVertex scale, LuxVertex rotation, uint8_t shader = NUM_SHADERS);
