...
bool Lux_D3D_Init(int width, int height, int bpp, bool fullscreen)
{
	...
	if (FAILED(hr))
	{
		std::cout << __FILE__ << ":" << __LINE__ << " | " << DXGetErrorString9(hr) << "\t" << DXGetErrorDescription9(hr) << std::endl;
		return false;
	}
	D3DCAPS9 d3dCaps;
	...
	std::cout << __FILE__ << ":" << __LINE__ << " | Video Driver: Direct3D" << std::endl;
	std::cout << __FILE__ << ":" << __LINE__ << " | Description: " <<  d3dAdapterID.Description<< std::endl;
	std::cout << __FILE__ << ":" << __LINE__ << " | Version: " << LOWORD(d3dAdapterID.DriverVersion.HighPart) << "." << HIWORD(d3dAdapterID.DriverVersion.LowPart) << std::endl;
	std::cout << __FILE__ << ":" << __LINE__ << " | Acceleration: HAL" << std::endl;
	std::cout << __FILE__ << ":" << __LINE__ << " | Max Texture Size: " << d3dCaps.MaxTextureWidth << "x" << d3dCaps.MaxTextureHeight << std::endl;
