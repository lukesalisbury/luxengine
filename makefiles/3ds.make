...
PLATFORM_LIBS := -L"$(DEVKITPRO)\devkitARM\lib" -L"$(DEVKITPRO)\libctru\lib" -L"$(DEVKITPRO)\portlibs\arm\lib"
PLATFORM_LIBS += -march=armv6k -mtune=mpcore -mfloat-abi=hard -specs=3dsx.specs
PLATFORM_LIBS += -lctru -lm
PLATFORM_FLAGS :=  -I"include" -I"$(DEVKITPRO)\devkitARM\arm-eabi\include" -I"$(DEVKITPRO)\libctru\include"
